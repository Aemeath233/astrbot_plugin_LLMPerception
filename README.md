...
- **发言者群身份**：QQ/NapCat 群聊中识别发言者是群主、管理员还是普通用户
- **机器人群身份**：QQ/NapCat 群聊中识别机器人是群主、管理员还是普通用户
- **消息类型**：识别是否包含图片、语音、视频
...
```
[发送时间: 2025-10-17 14:30:00 | 周五, 工作日, 下午 | 平台: QQ, 群聊, 发言者身份: 普通用户, 机器人身份: 管理员, 含图片]
用户的实际消息内容
```
...
调休工作日：
```
[发送时间: 2025-02-08 09:00:00 | 周六, 调休工作日, 上午 | 平台: QQ, 群聊, 发言者身份: 管理员, 机器人身份: 普通用户]
今天要上班吗？
```
